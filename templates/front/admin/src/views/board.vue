<template>
	<div class="content" :style='{"alignContent":"flex-start","minHeight":"100vh","overflow":"hidden","flexWrap":"wrap","background":"#1A2237","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		<div id="particles"></div>
		<div :style='{"margin":"0 auto","top":"40px","left":"4%","background":"url(http://codegen.caihongy.cn/20231222/4734f9bfb3e649da94447c871122c34a.png) no-repeat center top / auto 100%","width":"92%","lineHeight":"53px","position":"absolute","height":"53px"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0 auto","color":"#cdddf7","textAlign":"center","width":"auto","lineHeight":"auto","fontSize":"22px","fontWeight":"600","height":"auto"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"-58px","color":"rgba(255,255,255,.7)","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"80px","fontSize":"14px","position":"absolute","right":"0","height":"rgba(255,255,255,.7)"}'>{{ dates }}</div>
		</div>
		<div :style='{"padding":"0px 20px 0","display":"flex","height":"calc(100vh - 0px)"}'>
			<div :style='{"width":"28%","padding":"30px 10px 0 0","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
						<div :style='{"color":"#fff","fontSize":"16px","lineHeight":"42px"}'>
							老人统计
						</div>
					</div>
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="laorenChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="laorenChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"44%","padding":"103px 30px 0","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231222/aa62a48dbb054747a476b05b66a6de6d.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20231222/aa62a48dbb054747a476b05b66a6de6d.png) no-repeat right top / auto 100%","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"0px","margin":"20px 0 20px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"calc(50% - 93px)"}'>
					<el-carousel :style='{"width":"50%","margin":"0 auto"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="100%" :autoplay="false" :interval="3000" :loop="true">
						<el-carousel-item :style='{"borderRadius":"0","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture1">
							<el-image :style='{"width":"100%","objectFit":"cover","borderRadius":"20px","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture1" fit="cover"></el-image>
						</el-carousel-item>
						<el-carousel-item :style='{"borderRadius":"0","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture2">
							<el-image :style='{"width":"100%","objectFit":"cover","borderRadius":"20px","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture2" fit="cover"></el-image>
						</el-carousel-item>
						<el-carousel-item :style='{"borderRadius":"0","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture3">
							<el-image :style='{"width":"100%","objectFit":"cover","borderRadius":"20px","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture3" fit="cover"></el-image>
						</el-carousel-item>
					</el-carousel>
					<div :style='{"padding":"0 20px 0 0","margin":"0 0 0 20px","overflow":"hidden","color":"#ccc","alignItems":"center","flex":1,"display":"flex","lineHeight":"24px","fontSize":"14px","textIndent":"2em","height":"100%"}' v-html="systemIntroductionDetail.content"></div>
				</div>
				<!-- 统计 -->
				<div :style='{"alignContent":"flex-start","padding":"0px","margin":"0 0 20px","color":"#fff","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"center","height":"calc(50% - 40px)","order":"2"}'>

					<div :style='{"margin":"0 20px 0 0 ","alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						<div :style='{"margin":"0","top":"-4px","borderRadius":"100%","left":"55%","background":"#2097db","width":"12px","position":"absolute","height":"12px"}'></div>
						<div :style='{"padding":"0","margin":"20px 0 0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"block","justifyContent":"space-between"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>老人总数</div>
							<div :style='{"lineHeight":"40px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{laorenCount}}</div>
						</div>
					</div>

					<div :style='{"margin":"0 20px 0 0 ","alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						<div :style='{"margin":"0","top":"25%","borderRadius":"100%","background":"yellow","width":"12px","position":"absolute","right":"0px","height":"12px"}'></div>
						<div :style='{"padding":"0","margin":"10px 0 0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"block","justifyContent":"space-between"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>健康监测总数</div>
							<div :style='{"lineHeight":"auto","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{jiankangjianceCount}}</div>
						</div>
					</div>

					<div :style='{"alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						<div :style='{"margin":"0","top":"50%","borderRadius":"100%","background":"#2097db","width":"12px","position":"absolute","right":"-4px","height":"12px"}'></div>
						<div :style='{"padding":"0 20px","margin":"10px 0 0","alignItems":"center","textAlign":"center","justifyContent":"space-between","display":"block"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>服务订单总数</div>
							<div :style='{"lineHeight":"auto","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{fuwudingdanCount}}</div>
						</div>
					</div>
				</div>
			</div>
			<div :style='{"width":"28%","padding":"30px 0 0 10px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
						<div :style='{"color":"#fff","fontSize":"16px","lineHeight":"42px"}'>
							健康数据
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="jiankangjianceChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="fuwudingdanChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
  ...
  created() {
    this.$nextTick(()=>{
		...
		setTimeout(()=>{
			...
			this.laorenChat1();
			this.laorenChat2();
			this.getjiankangjianceCount();
			this.jiankangjianceChat3();
			this.getfuwudingdanCount();
			this.fuwudingdanChat4();
		},500)
	})
  },
  methods:{
...
//统计接口1
    laorenChat1() {
      this.$nextTick(()=>{
        ...
        var laorenChart1 = echarts.init(document.getElementById("laorenChart1"),'macarons');
        this.$http({
            url: "laoren/group/xingbie",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
...
//统计接口2
    laorenChat2() {
      this.$nextTick(()=>{
        ...
        var laorenChart2 = echarts.init(document.getElementById("laorenChart2"),'macarons');
        this.$http({
            url: "laoren/group/manxingbing",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].manxingbing);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].manxingbing
                    })
                }
                var option = {};
    ...
    getjiankangjianceCount() {
        this.$http({
            url: `jiankangjiance/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.jiankangjianceCount = data.data
            }
        })
    },
...
//统计接口1
    jiankangjianceChat3() {
      this.$nextTick(()=>{
        ...
        var jiankangjianceChart3 = echarts.init(document.getElementById("jiankangjianceChart3"),'macarons');
        this.$http({
            url: `jiankangjiance/valueMul/laorenzhanghao?yColumnNameMul=xinlv,xueya,xuetang,xueyang`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangjianceChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jiankangjianceChart3.resize();
                },false);
            }
        });
      })
    ...
    getfuwudingdanCount() {
        this.$http({
            url: `fuwudingdan/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.fuwudingdanCount = data.data
            }
        })
    },
...
//统计接口1
    fuwudingdanChat4() {
      this.$nextTick(()=>{
        ...
        var fuwudingdanChart4 = echarts.init(document.getElementById("fuwudingdanChart4"),'macarons');
        this.$http({
            url: "fuwudingdan/group/fuwuleixing",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                fuwudingdanChart4.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, fuwudingdanChart4)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    fuwudingdanChart4.resize();
                },false);
            }
        });
      })
