<template>
<div class="content" :style='{"padding":"30px","background":" url(http://codegen.caihongy.cn/20231205/b1037a84990a40d38531410083b9d519.jpg) repeat fixed center center / cover"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"margin":"50px auto","fontSize":"24px","color":"#fff","textAlign":"center","fontWeight":"bold","display":"none"}'>欢迎使用 {{this.$project.projectName}}</div>
	<!-- statis -->
	<div :style='{"margin":"0 0 20px 0","alignItems":"center","justifyContent":"center","display":"flex"}'>
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","background":"rgb(142, 195, 107)","display":"flex"}' v-if="isAuth('laoren','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"4px","background":"rgb(142, 195, 107)","display":"flex","width":"80px","justifyContent":"center","height":"80px"}'>
				<span class="icon iconfont icon-xihuan" :style='{"color":"#fff","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{laorenCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#fff","height":"24px"}'>老人总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","background":"rgb(83, 197, 130)","display":"flex"}' v-if="isAuth('jiankangjiance','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"4px","background":"rgb(83, 197, 130)","display":"flex","width":"80px","justifyContent":"center","height":"80px"}'>
				<span class="icon iconfont icon-xihuan" :style='{"color":"#fff","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{jiankangjianceCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#fff","height":"24px"}'>健康监测总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","background":"rgb(142, 195, 107)","display":"flex"}' v-if="isAuth('fuwudingdan','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"4px","background":"rgb(142, 195, 107)","display":"flex","width":"80px","justifyContent":"center","height":"80px"}'>
				<span class="icon iconfont icon-xihuan" :style='{"color":"#fff","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{fuwudingdanCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#fff","height":"24px"}'>服务订单总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
