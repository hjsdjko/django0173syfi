<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":" url(http://codegen.caihongy.cn/20231205/b1037a84990a40d38531410083b9d519.jpg) repeat fixed center center / cover"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="求助编号" prop="qiuzhubianhao">
					<el-input v-model="ruleForm.qiuzhubianhao" placeholder="求助编号" clearable  :readonly="ro.qiuzhubianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="求助编号" prop="qiuzhubianhao">
					<el-input v-model="ruleForm.qiuzhubianhao" placeholder="求助编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="救助回应" prop="jiuzhuhuiying">
					<el-input v-model="ruleForm.jiuzhuhuiying" placeholder="救助回应" clearable  :readonly="ro.jiuzhuhuiying"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="救助回应" prop="jiuzhuhuiying">
					<el-input v-model="ruleForm.jiuzhuhuiying" placeholder="救助回应" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="响应时间" prop="xiangyingshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.xiangyingshijian" 
						type="datetime"
						:readonly="ro.xiangyingshijian"
						placeholder="响应时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xiangyingshijian" label="响应时间" prop="xiangyingshijian">
					<el-input v-model="ruleForm.xiangyingshijian" placeholder="响应时间" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	created() {
		this.ruleForm.xiangyingshijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='qiuzhubianhao'){
							this.ruleForm.qiuzhubianhao = obj[o];
							this.ro.qiuzhubianhao = true;
							continue;
						}
						if(o=='laorenzhanghao'){
						...
						if(o=='jiuzhuhuiying'){
							this.ruleForm.jiuzhuhuiying = obj[o];
							this.ro.jiuzhuhuiying = true;
							continue;
						}
						if(o=='xiangyingshijian'){
							this.ruleForm.xiangyingshijian = obj[o];
							this.ro.xiangyingshijian = true;
							continue;
						}
				}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.renyuanbianhao!=''&&json.renyuanbianhao) || json.renyuanbianhao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.renyuanbianhao = json.renyuanbianhao
						this.ro.renyuanbianhao = true;
					}
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `jiuzhuxiangying/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jiuzhuxiangyingCrossAddOrUpdateFlag = false;
											this.parent.search();
