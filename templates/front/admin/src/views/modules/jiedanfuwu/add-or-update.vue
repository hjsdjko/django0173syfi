	...
	<div class="addEdit-block" :style='{"padding":"30px","background":" url(http://codegen.caihongy.cn/20231205/b1037a84990a40d38531410083b9d519.jpg) repeat fixed center center / cover"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="人员编号" prop="renyuanbianhao">
					<el-input v-model="ruleForm.renyuanbianhao" placeholder="人员编号" clearable  :readonly="ro.renyuanbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="人员编号" prop="renyuanbianhao">
					<el-input v-model="ruleForm.renyuanbianhao" placeholder="人员编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="人员姓名" prop="renyuanxingming">
					<el-input v-model="ruleForm.renyuanxingming" placeholder="人员姓名" clearable  :readonly="ro.renyuanxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="人员姓名" prop="renyuanxingming">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服务类型" prop="fuwuleixing">
					<el-input v-model="ruleForm.fuwuleixing" placeholder="服务类型" clearable  :readonly="ro.fuwuleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="服务类型" prop="fuwuleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="地址" prop="dizhi">
					<el-input v-model="ruleForm.dizhi" placeholder="地址" clearable  :readonly="ro.dizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="地址" prop="dizhi">
					<el-input v-model="ruleForm.dizhi" placeholder="地址" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服务费" prop="fuwufei">
					<el-input-number v-model="ruleForm.fuwufei" placeholder="服务费" :readonly="ro.fuwufei"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="服务费" prop="fuwufei">
					<el-input v-model="ruleForm.fuwufei" placeholder="服务费" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="计费标准" prop="jifeibiaozhun">
					<el-input v-model="ruleForm.jifeibiaozhun" placeholder="计费标准" clearable  :readonly="ro.jifeibiaozhun"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="计费标准" prop="jifeibiaozhun">
					<el-input v-model="ruleForm.jifeibiaozhun" placeholder="计费标准" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="计费" prop="jifei">
					<el-input-number v-model="ruleForm.jifei" placeholder="计费" :readonly="ro.jifei"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="计费" prop="jifei">
					<el-input v-model="ruleForm.jifei" placeholder="计费" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="订单费用" prop="dingdanfeiyong">
					<el-input v-model="dingdanfeiyong" placeholder="订单费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.dingdanfeiyong" label="订单费用" prop="dingdanfeiyong">
					<el-input v-model="ruleForm.dingdanfeiyong" placeholder="订单费用" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="服务详情" prop="fuwuxiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.fuwuxiangqing" label="服务详情" prop="fuwuxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.fuwuxiangqing"></span>
                </el-form-item>
...
export default {
	...
	computed: {
		...
		dingdanfeiyong:{
			get: function () {
				return 1*this.ruleForm.fuwufei*this.ruleForm.jifei
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='renyuanbianhao'){
							this.ruleForm.renyuanbianhao = obj[o];
							this.ro.renyuanbianhao = true;
							continue;
						}
						...
						if(o=='fuwufei'){
							this.ruleForm.fuwufei = obj[o];
							this.ro.fuwufei = true;
							continue;
						}
						if(o=='jifeibiaozhun'){
							this.ruleForm.jifeibiaozhun = obj[o];
							this.ro.jifeibiaozhun = true;
							continue;
						}
						if(o=='jifei'){
							this.ruleForm.jifei = obj[o];
							this.ro.jifei = true;
							continue;
						}
						if(o=='dingdanfeiyong'){
							this.ruleForm.dingdanfeiyong = obj[o];
							this.ro.dingdanfeiyong = true;
							continue;
						}
						if(o=='fuwuxiangqing'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fuwuxiangqing = this.ruleForm.fuwuxiangqing.replace(reg,'../../../django0173syfi/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
        this.ruleForm.dingdanfeiyong = this.dingdanfeiyong
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `jiedanfuwu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jiedanfuwuCrossAddOrUpdateFlag = false;
											this.parent.search();
