		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服务费" prop="fuwufei">
					<el-input v-model="ruleForm.fuwufei" placeholder="服务费" clearable  :readonly="ro.fuwufei"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="服务需求" prop="fuwuxuqiu">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.fuwuxuqiu" label="服务需求" prop="fuwuxuqiu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.fuwuxuqiu}}</span>
				</el-form-item>
