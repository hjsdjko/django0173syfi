<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"4px 30px","margin":"none","borderColor":"#d8dce5","background":"rgb(26, 179, 148)","borderWidth":"0px","width":"100%","borderStyle":"solid","height":"34px"}'>
