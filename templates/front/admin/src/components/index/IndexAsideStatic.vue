<template>
	<div class="menu-preview">
		...
		<div class="userinfo" :style='{"padding":"0 10px","alignItems":"center","flexDirection":"column","display":"none","position":"absolute","right":"0","justifyContent":"center","height":"60px"}'>
			...
			<div :style='{"fontSize":"12px","lineHeight":"1","color":"#fff","textAlign":"center"}'>{{this.$storage.get('adminName')}}</div>
		</div>
		<el-menu :default-active="activeMenu" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","whiteSpace":"nowrap","background":"transparent","display":"flex","position":"relative"}' mode="horizontal" class="el-menu-horizontal-2">
		    <el-menu-item class="home" :style='{"width":"120px","listStyle":"none","margin":"10px 20px 0 0","borderWidth":"0 0 1px 0","display":"none"}' @click.native="menuHandler('')" index="/">
				<div class="el-tooltip">
					<i :style='{"verticalAlign":"middle","fontSize":"18px","color":"inherit","textAlign":"center"}' class="icon iconfont icon-shouye-zhihui"></i>
					<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}' slot="title">系统首页</span>
				</div>
			</el-menu-item>
		    <el-submenu class="user" popper-class="user" :popper-append-to-body="false" :style='{"padding":"0","listStyle":"none","margin":"10px 1px 0 0","color":"#333","float":"left","background":"#1ab394"}' index="1">
				<template slot="title">
					<i :style='{"verticalAlign":"middle","margin":"0 0px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="icon iconfont icon-kuaijiezhifu"></i>
			...
			<template v-for="(menu,index) in menuList.backMenu">
				<el-submenu v-if="menu.child.length > 1 || !horizontalIsMultiple" class="other" popper-class="other" :popper-append-to-body="false" :style='{"border":"0","padding":"0","listStyle":"none","margin":"10px 1px 0 0","float":"left","background":"none"}' :index="index+2+''">
					<template slot="title">
						<i :style='{"verticalAlign":"middle","margin":"0 0px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu" :class="icons[index]"></i>
				...
				<el-menu-item v-if="menu.child.length <= 1 && horizontalIsMultiple" class="other" popper-class="other" :style='{"border":"0","padding":"0","listStyle":"none","margin":"10px 1px 0 0","float":"left","background":"none"}' @click="menuHandler(menu.child[0].tableName)" :index="'/'+menu.child[0].tableName">
				  <div class="el-tooltip">
				    <i :style='{"verticalAlign":"middle","margin":"0 0px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu" :class="icons[index]"></i>
