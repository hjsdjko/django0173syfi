<template>
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px 40px","borderColor":"#eee","alignItems":"center","color":"#fff","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"rgba(246,77,54,1)","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"80px","position":"fixed","borderStyle":"solid","height":"80px","zIndex":"1002"}'>
			<!-- info -->
			<div :style='{"margin":"0","left":"40px","background":"none","display":"inline-block","width":"30%","position":"absolute","float":"left","height":"80px"}'>
			  <span :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"18px","fontWeight":"600","height":"80px"}'>基于大数据技术的智慧居家养老服务平台</span>
			</div>
    ...
    methods: {
		...
		async getSession() {
			await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
				if (res.data.code == 0) {
					if(res.data.data.manxingbing){
						res.data.data.manxingbingArray = res.data.data.manxingbing.split(',')
					}else{
						res.data.data.manxingbingArray = []
					}
