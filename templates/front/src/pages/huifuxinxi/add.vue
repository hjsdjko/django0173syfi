...
<div :style='{"width":"100%","padding":"30px 18% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="交流编号" prop="jiaoliubianhao">
            <el-input v-model="ruleForm.jiaoliubianhao" 
                placeholder="交流编号" clearable :disabled=" false  ||ro.jiaoliubianhao"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="交流者" prop="jiaoliuzhe">
            <el-input v-model="ruleForm.jiaoliuzhe" 
                placeholder="交流者" clearable :disabled=" false  ||ro.jiaoliuzhe"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="回复时间" prop="huifushijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="回复内容" prop="huifuneirong">
            <editor 
